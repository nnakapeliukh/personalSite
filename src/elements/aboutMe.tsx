		...
		<Container>
			<Container className='shadow mt-5 p-4'>
				<Row className=''>
						...
						<Row className='pt-4 '>
							...
							<Col className='module' xs>						
								...
								<a
									...
									onClick={() => setIsSkillsCollapseOpen(!isSkillsCollapseOpen)}
					...
					<Col xs={12} md={6}>
						<h3>About me</h3>
						<p className='lead'>Young and strong man, whoi is interested in everything tech.
							I have stong background in designing complex systems and executing 
							various parts: from UX design to PCB design. All of these things are integrated
							to become a product.
							I know how to bring value: during &apos;slower&apos; periouds I always 
							try to find a way on how to 
						</p>
					</Col>
				</Row>
			</Container>
